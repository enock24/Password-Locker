    ...
    if ask == "no":
        ...
        while True:
            ...
            if short_code == "cc":
                ...
                print("Enter account for example instagram, facebook....")
                account = input("> ")
        ...
        while True:
            ...
            if short_code == "cc":
                ...
                print("\n")
                print(
                    f"New credential Name:{name}, Account:{account}, username:{username}, Password:{password} have just been created!")
                ...
                for credential in display_credentials():
                    print(
                        f"Name:{credential.name}, Account:{credential.account}, Username:{credential.username}, and password:{password}")
                else:
                    print("\n")
